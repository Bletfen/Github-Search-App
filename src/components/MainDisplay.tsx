...
export default function MainDisplay({
  ...
  return (
    ...
    >
      ...
      <div
        className="flex py-[1.8rem] px-[1.5rem] text-[#4b6a9b]
        ...
        <div className="flex flex-col gap-[1.6rem]">
          <div className="flex gap-[1.9rem]">
            <svg
              ...
              className={userInfo?.location ? "opacity-[1]" : "opacity-[0.5]"}
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
          ...
          <div className="flex gap-[1.3rem]">
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className={userInfo?.blog ? "opacity-[1]" : "opacity-[0.5]"}
            >
              <path
        ...
        <div className="flex flex-col gap-[1.6rem]">
          <div className="flex gap-[1.3rem]">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              className={
                userInfo?.twitter_username ? "opacity-[1]" : "opacity-[0.5]"
              }
            >
              <path
          ...
          <div className="flex gap-[1.3rem]">
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className={userInfo?.company ? "opacity-[1]" : "opacity-[0.5]"}
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
